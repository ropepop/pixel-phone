...
- `pixel-orchestrator-observability-prod`: private, general orchestrator history with fixed enums/scalars and database-time 24-hour expiry. Ticket events remain in the Ticket domain database.

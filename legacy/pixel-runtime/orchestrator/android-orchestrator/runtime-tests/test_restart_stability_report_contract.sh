...
[2026-03-12T02:52:18+0200] runtime-tail: [2026-03-12T00:49:43+0000] status:listen_https :2789 down
[2026-03-12T02:52:25+0200] runtime-tail: [2026-03-12T00:52:10+0000] status:listen_dot :2790 down
...
if ! jq -e '.findings[] | select(.component=="dns" and .kind=="restart_storm" and .event_count==5 and (.down_listeners | index("https:2789")) and (.down_listeners | index("dot:2790")))' "${json_out}" >/dev/null; then

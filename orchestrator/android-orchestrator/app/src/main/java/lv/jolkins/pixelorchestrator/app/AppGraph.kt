...
object AppGraph {
  ...
  fun facade(context: Context): OrchestratorFacade {
    ...
    synchronized(this) {
      ...
      val cpuFrequencyController = CpuFrequencyComponentController(
        context = appContext,
        settingsStore = CpuFrequencyPreferencesStore(appContext),
      ...
      val created = OrchestratorFacade(
        ...
        healthChecker = healthChecker,
        cpuFrequencyController = cpuFrequencyController,

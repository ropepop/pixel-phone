...
internal object TicketTracePrivacy {
  private val numericFields = setOf(
    ...
    "clients",
    "count",
    "database_to_finished_ms",
    "database_to_first_tap_ms",
    "database_to_popup_ready_ms",
    "database_to_browser_ack_ms",
    "database_to_phone_ms",
    "database_to_result_ms",
    "duration_ms",
    "elapsed_ms",
    "fps",
    "frame_age_ms",
    ...
    "nodes",
    "phone_to_input_typed_ms",
    "phone_to_first_input_ms",
    "phone_to_first_tap_ms",
    "phone_to_marker_ready_ms",
    "phone_to_ok_tap_ms",
    "phone_to_popup_ready_ms",
    "phone_to_result_ms",
    "phone_to_ticket_detail_ready_ms",
    "phone_to_gate_ms",
    "phone_to_browser_ack_ms",
    "phone_to_cleanup_ms",
    "popup_open_ms",
    "popup_to_first_input_ms",
    "startup_fps",
    "startup_frames",
    "stdout_len",
    "timeout_ms",
  ...
  private val booleanFields = setOf(
    ...
    "ok",
    "popup_input_present",
    "popup_edit_text_present",
    "popup_label_present",
    "popup_submit_present",
    "popup_surface_proved",
    "recovered",
    "stream_active",
    "success",
    "video",
